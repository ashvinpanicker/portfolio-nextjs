    ...
    >
      ...
      >
          <Image
            ...
            height={800}
            className="
                block sm:absolute sm:top-8 sm:-right-40 w-full sm:w-[28.25rem] rounded-t-lg shadow-2xl
                transition 
        ...
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          ...
          <ul className="flex flex-wrap mt-4 gap-2 sm:mt-auto">
            {tags.map((tag, index) => (
              <li
                className="bg-black/[0.9] dark:bg-black/[0.7] px-3 py-1 text-[0.7rem] uppercase tracking-wider text-white rounded-full dark:text-white/70"
                key={index}
              >
                {tag}
              </li>
